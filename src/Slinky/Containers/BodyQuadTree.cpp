...
namespace Slinky::Containers {
    ...
    bool BodyQuadTree::Insert(Dynamics::Body *body)
    {
        if (!Collision::Contains(bounds, body->collider)) return false;
    ...
    void BodyQuadTree::GetPairs(std::vector<std::pair<Dynamics::Body*, Dynamics::Body*>> &pairs)
    {
    ...
    void BodyQuadTree::GetPairsInChild(std::vector<std::pair<Dynamics::Body *, Dynamics::Body *>> &pairs,
                                       Dynamics::Body *body,
                                       BodyQuadTree* child)
    {
